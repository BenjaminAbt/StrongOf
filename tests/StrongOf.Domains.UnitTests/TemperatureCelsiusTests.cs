...
public class TemperatureCelsiusTests
{
    ...
    {
        TemperatureCelsius temp = new TemperatureCelsius(20m);
    ...
    {
        TemperatureCelsius temp = new TemperatureCelsius(value);
    ...
    {
        TemperatureCelsius temp = new TemperatureCelsius(0m);
    ...
    {
        StrongDecimalTypeConverter<TemperatureCelsius> converter = new StrongDecimalTypeConverter<TemperatureCelsius>();
        TemperatureCelsius? result = converter.ConvertFrom(null, System.Globalization.CultureInfo.InvariantCulture, "20") as TemperatureCelsius;
    ...
    {
        StrongDecimalTypeConverter<TemperatureCelsius> converter = new StrongDecimalTypeConverter<TemperatureCelsius>();
        TemperatureCelsius? result = converter.ConvertFrom(20m) as TemperatureCelsius;
    ...
    {
        StrongDecimalTypeConverter<TemperatureCelsius> converter = new StrongDecimalTypeConverter<TemperatureCelsius>();
        TemperatureCelsius? result = converter.ConvertFrom(20.5) as TemperatureCelsius;
    ...
    {
        StrongDecimalTypeConverter<TemperatureCelsius> converter = new StrongDecimalTypeConverter<TemperatureCelsius>();
        TemperatureCelsius? result = converter.ConvertFrom(20) as TemperatureCelsius;
