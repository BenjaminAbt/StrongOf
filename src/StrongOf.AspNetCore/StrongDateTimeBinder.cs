...
public abstract class StrongDateTimeBinder<TStrong> : StrongOfBinder
    where TStrong : StrongDateTime<TStrong>
{
    ...
    {
        if (StrongDateTime<TStrong>.TryParse(value, CultureInfo.InvariantCulture.DateTimeFormat, out TStrong? strong))
        {
